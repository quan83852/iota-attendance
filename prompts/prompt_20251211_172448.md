...
- **Available Methods:**
  ...
  * `create_session` (constant: `CREATE_SESSION`)
  * `check_in` (constant: `CHECK_IN`)
  * `get_count` (constant: `GET_COUNT`)

---

# **Move Contract: `contract/attendance/sources/attendance.move`**
...
- Use Package ID: `0xe7a4eb3db0d780f6ca5525b9e0bf12ba64220d05ef7cf13a8afc330b9cbf9bac` and Module: `contract`
